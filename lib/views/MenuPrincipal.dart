  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 1) {
            // Cuando se selecciona el ítem de "Recetas", navega a la pantalla menuRecetas
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => RecipesPage()),
            );
          }
          // Puedes agregar otros índices para navegar a otras pantallas si lo deseas
        },
      ),
    );
  }
