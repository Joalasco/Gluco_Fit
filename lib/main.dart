...
class RecipesPage extends StatelessWidget {
  ...
  Widget _buildRecipeGrid() {
    return GridView.count(
      ...
      childAspectRatio: 1,
      children: [
        _buildRecipeCard('Avocado Salad', '230 kcal', 'assets/avocado_salad.jpg'),
        _buildRecipeCard('Breakfast Bowl', '220 kcal', 'assets/breakfast_bowl.jpg'),
        _buildRecipeCard('Healthy Snacks', '250 kcal', 'assets/healthy_snacks.jpg'),
        _buildRecipeCard('Meal salad', '280 kcal', 'assets/meal_salad.jpg'),
      ],
    );
  }
      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              _buildTrendingCard('Avocado Tost', '2 servings', 'assets/avocado_toast.jpg'),
              _buildTrendingCard('Green salad', '2 servings', 'assets/green_salad.jpg'),
            ],
          ),
        ),
      ],
